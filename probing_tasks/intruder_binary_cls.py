...
if __name__ == "__main__":
    ...
    for image_name in os.listdir(data_directory + "/CLEVR/images/without_intruder/train/"):
        image = data_directory + "/CLEVR/images/without_intruder/train/" + image_name
        train.append((image, 0))

    for image_name in os.listdir(data_directory + "/CLEVR/images/without_intruder/test/"):
        image = data_directory + "/CLEVR/images/without_intruder/test/" + image_name
        test.append((image, 0))
